...
from utils.model import test, get_params, set_params, get_fedprox_loss_function
...
def get_fedprox_client_fn(client_ds, train_root: str, val_batches: int, val_batch_size: int, max_steps_for_clients: List[int], context_len: int, pred_len: int, log_path: str, save_dir: str = ""):
