...
from utils.model import test, get_params, set_params, get_fedprox_loss_function, restore_state_dict
...
class FlowerClient(NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        if not os.path.exists(self.local_model_path):    
            ...
            set_params(self.model, self.load_local_params())
    ...
    def evaluate(self, parameters: NDArrays, config: Dict[str, Scalar]):
        ...
        if not os.path.exists(self.local_model_path):    
            ...
            set_params(self.pipeline.model, self.load_local_params())
...
def get_hybrid_client_fn(client_ds, train_root: str, val_batches: int, val_batch_size: int, max_steps_for_clients: List[int], context_len: int, pred_len: int, log_path: str, save_dir: str = ""):
