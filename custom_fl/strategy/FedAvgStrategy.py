...
class FedAvgStrategy(FedAvg):
    ...
    def aggregate_fit(
        ...
        if aggregated_parameters is not None:
            ...
            print(f"Saving round {server_round + self.round_offset} aggregated_ndarrays...")
            np.savez(os.path.join(self.log_path, f"round-{server_round + self.round_offset}-weights.npz"), *aggregated_ndarrays)
